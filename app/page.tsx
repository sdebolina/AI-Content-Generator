...
export default function Home() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col justify-center items-center bg-gradient-to-r from-[#F05A7E] to-[#FFE5CF] overflow-hidden">
      {/* Floating Clouds */}
      ...
      >
        ...
        >
          Empower Your Content Creation Journey with WordWiz
        </motion.p>

        <motion.button
          onClick={handleGetStarted}
          className="px-6 py-3 bg-[#EF5A6F] text-white-600 rounded-full font-semibold text-lg shadow-lg hover:bg-indigo-100 transition duration-300"
      ...
      <motion.div
        className="absolute w-72 h-72 bg-[#FFEEAD] rounded-full opacity-20 blur-2xl z-0"
      ...
      />
      <motion.div
        className="absolute w-96 h-96 bg-[#FFEEAD] rounded-full opacity-30 blur-2xl z-0"
        initial={{ scale: 0, rotate: 0 }}
